...
public class ReviewDbStorage implements ReviewStorage {
    ...
    public Review getReviewById(long id) throws ObjectNotFoundException {
        return jdbcTemplate.query(SQL_GET_REVIEW_BY_ID, this::makeReview, id)
                .stream()
                .findAny()
                .orElseThrow(() -> new ObjectNotFoundException("Review with id=" + id + " doesn't exist"));
    }
    ...
    public Review addReview(Review review) {
        ...
        log.trace("Object was saved: {}", review);
        return review;
    }
    ...
    public Review updateReview(Review review) {
        jdbcTemplate.update(
                ...
                review.getReviewId());
        log.trace("Review was updated: {}", review);
    ...
    public void deleteReviewById(long id) {
        ...
        log.trace("Review was deleted: {}", review);
    }
